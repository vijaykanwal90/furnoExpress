    ...
    <div className="container mx-auto px-4 py-8 text-black">
      <div className="max-w-2xl mx-auto border p-6 rounded-lg shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2">We&apos;d love to hear from you. Please fill out the form below and we&apos;ll get back to you as soon as possible.</p>
        </div>
        <form onSubmit={onSubmit} className="space-y-6 mt-6">
          ...
          <div className="form-item">
            <label className="block text-lg font-medium" htmlFor="phone">Phone</label>
            <input
              id="phone"
              type="tel"
              name="phone"
